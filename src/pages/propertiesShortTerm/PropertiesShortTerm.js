...
import './propertiesshortTerm.css';

export default function PropertiesshortTerm() {

    const [shortTermAppartments, setShortTermAppartments] = useState(shortTermApartmentsData)
    ...
    const currentAppartments = shortTermAppartments.slice(firstAppartmentIndex, lastAppartmentIndex);
   
    return (
        <>
          <SearchForm setShortTermAppartments={setShortTermAppartments} setCurrentPage={setCurrentPage}/>
            ...
            {currentAppartments.map((item)=>{
                return (
                       <div className="singleApartment" key={Math.random()}>
                                ...
                                <div className="">{item.price} <FontAwesomeIcon icon={faEuro} /> / month</div>
         ...
         {currentAppartments.length > 0 &&  
            <Pagination 
                    ...
                    resultantAppartments={shortTermAppartments}
                />}
        </>
