...
import './propertiesLongTerm.css';

export default function PropertiesLongTerm() {

    const [longTermAppartments, setLongTermAppartments] = useState(longTermApartmentsData);
    ...
    const currentAppartments = longTermAppartments.slice(firstAppartmentIndex, lastAppartmentIndex);

   
    return (
        <>
          <SearchForm setLongTermAppartments={setLongTermAppartments} setCurrentPage={setCurrentPage}/>
         ...
         {currentAppartments.length > 0 && 
            <Pagination 
                        ...
                        resultantAppartments={longTermAppartments}
            />}
        </>
